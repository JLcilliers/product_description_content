...
import FOOD_INGREDIENTS_PROMPTS from './food-ingredients.js';
 ...
 */
export function getPromptsForCategory(category, businessName = null) {
  // Validate input
  if (!category || typeof category !== 'string') {
 ...
 */
export function testCategoryForIndustry(category, industryName) {
